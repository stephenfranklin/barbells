...
#### Trees Analysis
Our tree model is not better than chance. The in-sample error rate (from a 10-fold cross-validation) is 51.1% (`barb.tr$results`). The out-of-sample error rate is 50.2%.
...
sum(testing$predtrRight)/nrow(testing)  ## out of sample error rate
...
imp <- as.data.frame(barb.rf$finalModel$importance, r)
